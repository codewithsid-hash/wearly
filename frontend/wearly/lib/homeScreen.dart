...
Future<void> fetchItemCount() async {
  try {
    final response = await http.get(Uri.parse('http://wearlyfinal-102927385476.asia-south1.run.app/wardrobe/total'));
...
Future<int?> fetchOutfitCount() async {
  final url = Uri.parse("http://wearlyfinal-102927385476.asia-south1.run.app/outfits/count"); // Replace with your actual IP
  try {
...
void _startAnimations() {
  ...
  Navigator.push(
    context,
    MaterialPageRoute(builder: (_) => ARFeaturePage()),
  );
}),
